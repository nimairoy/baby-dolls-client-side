...
const GalleryCard = ({gallery}) => {
    ...
    return (
        <div  data-aos="fade-up" data-aos-duration="3000" className='relative mt-4 overflow-hidden shadow-md shadow-slate-200 hover:scale-95 duration-300 hover:shadow-2xl img-parent'>
